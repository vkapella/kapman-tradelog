...
export function DataPagePanel({ heading, nextAction }: DataPagePanelProps) {
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface p-6">
      <h2 className="text-lg font-semibold text-text">Populated state</h2>
      <p className="mt-2 text-sm text-text-2">{heading}</p>
      <dl className="mt-4 grid gap-2 text-sm text-text">
