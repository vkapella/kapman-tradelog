...
export async function GET(request: Request) {
  ...
  if (coveringRun) {
    ...
    const payload: ReconciliationResponse = {
      ...
      tradingFees: money(sum((child) => child.tradingFees ?? null)),
  ...
  const payload: ReconciliationResponse = {
    ...
    inKindContributions: toPositionSnapshotMoneyString(snapshot.inKindContributions),
    tradingFees: toPositionSnapshotMoneyString(snapshot.tradingFees),
