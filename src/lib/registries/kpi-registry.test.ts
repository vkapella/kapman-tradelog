...
function buildSummary(overrides: Partial<OverviewSummaryResponse["returnOnCapital"]>): OverviewSummaryResponse {
  return {
    ...
    returnOnCapital: {
      beginningValue: null,
      beginningValueSource: "unavailable",
    ...
    scope: { requestedAccountIds: [], resolvedAccountIds: [], legalEntities: [], environments: [], mixedEntity: false, mixedEnvironment: false, unscopedRequest: true },
    profitFactor: null,
    expectancy: null,
    maxDrawdown: null,
